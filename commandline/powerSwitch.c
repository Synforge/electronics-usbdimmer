...
static void usage(char *name)
{
    ...
    fprintf(stderr, "  %s set <port> <level>\n", name);
 ...
 */
        ...
        nBytes = usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_IN, PSCMD_SET, port, level, (char *)buffer, sizeof(buffer), 5000);
